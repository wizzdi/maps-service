...
public interface IMapIconRepository {
   ...
   */
  List<MapIcon> listAllMapIcons(MapIconFilter filtering, SecurityContextBase securityContext);

  <T extends MapIcon> void addMapIconPredicate(
   ...
   */
  Long countAllMapIcons(MapIconFilter filtering, SecurityContextBase securityContext);
